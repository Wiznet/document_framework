...
Eg:-
Suppose &#39;website&#39; is your project folder then navigate to website > src > pages and create the code file with the file name same as the one you want to reflect on the URL (Routing path).
