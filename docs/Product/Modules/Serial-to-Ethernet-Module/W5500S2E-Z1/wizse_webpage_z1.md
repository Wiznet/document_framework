...
Open the Chrome browser, enter the W5500S2E series module's IP address in the address bar (the factory default is 192.168.1.88), and the login interface shown in the ﬁgure below will appear.
...
**Logout:** Logout Button to logout the W5500S2E series configuration page. It shows the following window, click "Ok' will jump to login page.
