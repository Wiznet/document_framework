...
<Tabs groupId="Firmware">
  ...
  - [Firmware Download Guide](./Download.md)

  | Title | Description                        | Download      | Notes |
  |-------|------------------------------------|---------------|-------|
  | firmware | Application Firmware  | ![link](\img\link.png) [Application v1.2.2](https://github.com/Wiznet/WIZ550SR/releases) |  For ConfigTool only |
  | ::: | All (Boot + App)           | ![link](\img\link.png) [All v1.2.2](https://github.com/Wiznet/WIZ550SR/releases)                 | For Flash Loader Demonstrator only |
  ...
  WIZ550SR Firmware source code link

  ![link](\img\link.png) [**WIZ550SR Series GitHub Repository**](https://github.com/Wiznet/WIZ550SR)
...
| Title | Description | Download | Notes |
|-------|-------------|----------|-------|
| schematic | Circuit diagram for hardware design reference | ![download](/img/products/w5500/w5500_evb/icons/download.png) [Altium](/img/products/wiz550sr/wiz550sr_ds/wiz550sr_sch_v100.zip) / ![download](/img/products/w5500/w5500_evb/icons/download.png) [PDF](/img/products/wiz550sr/wiz550sr_ds/wiz550sr_sch_v100.pdf) | Latest version H/W |
| 3D File | 3D model for mechanical design and visualization | ![download](/img/products/w5500/w5500_evb/icons/download.png) [Altium](/img/products/3d-step-files/WIZ550SR_V1.0.step) | ::: |
| Part list | List of components used in the hardware | ![download](/img/products/w5500/w5500_evb/icons/download.png) [PDF](/img/products/wiz550sr/wiz550sr_ds/wiz550sr_bom_v100_160511.pdf) | ::: | 

:::note

Old versions of the hardware resources can be found at [**this link**](https://docs.wiznet.io/Product/Modules/Serial-to-Ethernet-Module/WIZ550SR/datasheet-EN#schematics--bom).
...
## Evaluation Boards
  ...
  <a
    href="/Product/Modules/Serial-to-Ethernet-Module/WIZ550SR/datasheet-EN#wiz550sr-evb"
    target="_blank"
