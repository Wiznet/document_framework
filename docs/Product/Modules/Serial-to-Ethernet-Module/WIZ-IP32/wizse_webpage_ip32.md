...
Open the Chrome browser, enter the IP address of WIZ-IP32 in the address bar (the factory default is 192.168.1.88), and the login interface shown in the ﬁgure below will appear.
...
- **Select Modbus Mode:** In WIZ-IP32 , it includes Modbus RTU and Modbus ASCII formats to let the user to communicate using Modbus TCP. **The default is Modbus RTU.**
...
**Logout:** Logout Button to logout of the WIZ-IP32  configuration page. It shows the following window, click "Ok' will jump to login page.
