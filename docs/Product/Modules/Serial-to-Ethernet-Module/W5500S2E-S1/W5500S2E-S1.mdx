...
W5500S2E is a series of industrial grade serial to Ethernet module. It supports TCP server, TCP client, UDP and Modbus modes. The maximum baud rate of the serial port is 1.152Mbps. W5500S2E supports the WIZS2E ConﬁﬁgTool (Conﬁﬁguration Tool for Windows®), a web page, and AT commands for conﬁguration.
