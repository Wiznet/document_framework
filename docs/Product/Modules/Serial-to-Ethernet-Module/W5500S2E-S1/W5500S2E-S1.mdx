...
W5500S2E is a series of industrial grade serial to Ethernet module. It supports TCP server, TCP client, UDP and Modbus modes. The maximum baud rate of the serial port is 1.152Mbps. W5500S2E supports the WIZS2E ConﬁgTool (Conﬁguration Tool for Windows®), a web page, and AT commands for conﬁguration.

W5500S2E integrated with the hardwired TCP/IP protocol Ethernet chip W5500. This enables faster, more stable, and secure Ethernet connectivity. With reference to the schematic(s) and guideline(s) in this user manual, user can simplify the design and reduce development time. 
...
## Features
  ...
  - **Built-in web server** for browser and remote conﬁguration
  - Provide a user-friendly configuration tool program (WIZS2E ConfigTool)
...
| Datasheet | Technical specifications | ![link](\img\docs_icon_small.png) [EN](./Datasheet_s1.md) | - |
...
| Title | Description | Link | Notes |
|-------|-------------|------|-------|
| Command Manual | Guide to main commands and usage | ![link](\img\link.png)[EN](./wizse_at_command_s1.md) | - |
| Configuration Tool Manual | How to use the configuration tool | ![link](\img\link.png)[EN](./wizse_config_tool_s1.md) | - |
| Web Server Configuration Guide | Web-based configuration guide | ![link](\img\link.png)[EN](./wizse_webpage_s1.md) | - |
...
| Title | Description | Link | Notes |
|-------|-------------|------|-------|
| Getting Started | Quick setup instructions for using your W5500S2E device | - | TBD |
