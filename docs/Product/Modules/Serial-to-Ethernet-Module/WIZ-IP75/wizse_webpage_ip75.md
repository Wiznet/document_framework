...
Open the Chrome browser, enter the IP address of WIZ-IP75 in the address bar (the factory default is 192.168.1.88), and the login interface shown in the ﬁgure below will appear.
...
**Logout:** Logout Button to logout of the WIZ-IP75  configuration page. It shows the following window, click "Ok' will jump to login page.
