...
<summary>The module restarts when it cannot communicate with the UDP Remote Host.</summary>
  ...
  - Starting from firmware V1.4.x, WIZ750SR includes a Watchdog function to prevent the system from remaining in a long waiting state during network processing due to network disconnection or data transmission/reception failure.
...
|                                                             |
| ----------------------------------------------------------- |
| ![](/img/products/wiz750sr/troubleshooting/config_tool.png) |
...
- The latest version Configuration tool can be downloaded at this [download page](./Download.mdx).
...
2.  Check the ‘Firmware version' 
  ...
  - User can check the latest firmware version at the [product update history page](./Series-Update-History-EN.md) and [download page](./Download.mdx).
