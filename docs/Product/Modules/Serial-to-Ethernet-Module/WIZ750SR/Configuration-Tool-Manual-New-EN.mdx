...
**Supported Languages** 
  * [English](./Configuration-Tool-Manual-New-EN.mdx) (current page)  
  * [Korean](./Configuration-Tool-Manual-New-KO.mdx)
...
#### 2\) Operation mode
  ...
  - Details of each network operation mode are available at [WIZ750SR User's Manual: Network Operation Mode](./Users-Manual-EN.mdx#network-operation-mode). 
