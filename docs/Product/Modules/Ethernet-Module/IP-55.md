...
<div className="main_intro"> 
  <div className="main_intro_image">
    <img src="/img/products/wiz-ip55/WIZ-IP55 diagonal2.png" width="300" />
  </div>
  <div className="wiz-ip55s-text">
    <p>
...
| User Manual | A document that explains the information and details of the product | ![link](\img\link.png) [EN](/img/products/wiz-ip55/WIZ-IP55_User_Manual_20250815_V1.0.pdf) | -     |
...
| IP55-SCH| 	Schematic symbol library for Altium Designer |![download](/img/products/w5500/w5500_evb/icons/download.png)[download](/img/products/wiz-ip55/WIZIP55.SchLib)|    |  |
| IP55-PCB |PCB footprint library for Altium Designer |![download](/img/products/w5500/w5500_evb/icons/download.png) [download](/img/products/wiz-ip55/WIZIP55.PcbLib)|  |

---

## Mechanical Information
<img src="/img/products/wiz-ip55/IP55 Mechanical Information.png" alt="Wiz-ip55 Mechanical Information" />
...
- <a href="/img/products/wiz-ip55/KC적합등록필증_㈜위즈네트_WIZ-IP55.pdf" target="_blank">KC test</a>
- <a href="/img/products/wiz-ip55/FCC_SDoC_WIZ-IP55.pdf" target="_blank">FCC test</a>
- <a href="/img/products/wiz-ip55/CE_DoC_WIZ-IP55.pdf" target="_blank">CE test</a>
