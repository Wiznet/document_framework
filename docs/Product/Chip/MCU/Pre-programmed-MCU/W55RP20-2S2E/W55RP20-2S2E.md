...
| 10         | DATA0_ RX_PIN / DATA_SPI_CSn_PIN | RX pin for Data0 UART reception (UART Mode) / SPI Chip Select pin (SPI Mode)  |
...
| 16         | STATUS_PHYLINK_PIN | Output High when the PHY link is established |
