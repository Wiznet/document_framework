...
![gnuwin32](http://wizwiki.net/wiki/lib/exe/fetch.php?media=products:w7500:documents:appnote:1_gnuwin32.jpg "gnuwin32")

2.Click the packages in left category.
![gnuwin32](http://wizwiki.net/wiki/lib/exe/fetch.php?media=products:w7500:documents:appnote:2_gnuwin32.jpg "gnuwin32")

3.Find the **Make** file using scroll and click, Click the **Setup program** in Download.
![gnuwin32](http://wizwiki.net/wiki/lib/exe/fetch.php?media=products:w7500:documents:appnote:3_gnuwin32.jpg "gnuwin32")

4.When download time left as '0', you get the **setup file**.
![gnuwin32](http://wizwiki.net/wiki/lib/exe/fetch.php?media=products:w7500:documents:appnote:4_gnuwin32.jpg "gnuwin32")

5.Finish the setup,copy the program setup path(you reach until **make.exe**)

![gnuwin32](http://wizwiki.net/wiki/lib/exe/fetch.php?media=products:w7500:documents:appnote:5_gnuwin32.jpg "gnuwin32")

6.In my case,the setup path is **C:\Program Files\GnuWin32\bin**

![gnuwin32](http://wizwiki.net/wiki/lib/exe/fetch.php?media=products:w7500:documents:appnote:6_gnuwin32.jpg "gnuwin32")
...
![gnuwin32](http://wizwiki.net/wiki/lib/exe/fetch.php?media=products:w7500:documents:appnote:7_gnuwin32.jpg "gnuwin32")
...
![armgcc](http://wizwiki.net/wiki/lib/exe/fetch.php?media=products:w7500:documents:appnote:1_armgcc.jpg "armgcc")
...
![armgcc ](http://wizwiki.net/wiki/lib/exe/fetch.php?media=products:w7500:documents:appnote:2_armgcc.jpg "armgcc")

4.The installation path setup and click the **'NEXT'**, click the **'NEXT'** again.

![armgcc ](http://wizwiki.net/wiki/lib/exe/fetch.php?media=products:w7500:documents:appnote:4_armgcc.jpg "armgcc")
...
![armgcc ](http://wizwiki.net/wiki/lib/exe/fetch.php?media=products:w7500:documents:appnote:5_armgcc.jpg "armgcc")

6.The command window will be opened,you can know the arm gcc setup path it. 

![make](http://wizwiki.net/wiki/lib/exe/fetch.php?media=products:w7500:documents:appnote:6_make.jpg "make")

7.Confirm the version of arm gcc using the command of below.
> arm-none-eabi-gcc --version

![make](http://wizwiki.net/wiki/lib/exe/fetch.php?media=products:w7500:documents:appnote:7_make.jpg "make")
* * *
...
![make](http://wizwiki.net/wiki/lib/exe/fetch.php?media=products:w7500:documents:appnote:8_make.jpg "make")

2.You can see the compile as below.
![make](http://wizwiki.net/wiki/lib/exe/fetch.php?media=products:w7500:documents:appnote:9_make.jpg "make")


3.If success, the files will create. The path of make file is a place the makefile.

![make](http://wizwiki.net/wiki/lib/exe/fetch.php?media=products:w7500:documents:appnote:10_make.jpg "make")
