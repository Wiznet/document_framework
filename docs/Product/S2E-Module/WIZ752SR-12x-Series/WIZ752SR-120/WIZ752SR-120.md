...
|                                                             |
| ----------------------------------------------------------- |
| <a target="_blank" href={require("/img/products/s2e_module/wiz752sr-120/3.png").default}><img src={require("/img/products/s2e_module/wiz752sr-120/3.png").default} alt="WIZ752SR-120"/></a> |
| Figure: ***WIZ752SR-120***                                  |
...
| **Module**                                      |
| ----------------------------------------------- |
| <a target="_blank" href={require("/img/products/s2e_module/wiz752sr-120/3.png").default}><img src={require("/img/products/s2e_module/wiz752sr-120/3.png").default} alt=""/></a> |
