...
const Link = (name) => {
	switch (name) {
		case 'W7500':
			return window.open(
				'/docs/Product/iMCU/W7500/overview',
				'_self'
			);
		case 'W7500p':
			return window.open(
			 '/docs/Product/iMCU/W7500p/overview',
				'_self'
			);
		case 'W7100A':
			return window.open(
				'/docs/Product/iMCU/W7100A/overview',
				'_self'
			);
		case 'W7500(P)-S2E':
			return window.open(
				'/docs/Product/Pre-programmed-MCU/W7500P-S2E/w7500p-s2e-[EN]',
				'_self'
			);
		case 'W6100':
			return window.open(
				'/docs/Product/iEthernet/W6100/overview',
				'_self'
			);
		case 'W5100S':
			return window.open(
				'/docs/Product/iEthernet/W5100S/overview',
				'_self'
			);
		case 'W5500':
			return window.open(
				'/docs/Product/iEthernet/W5500/overview',
				'_self'
			);
		case 'W5300':
		...
		case 'W7500S2E-R1':
			return window.open(
				'/docs/Product/S2E-Module/W7500S2E-R1/w7500s2e_r1',
				'_self'
			);
		case 'W7500S2E-S1':
			return window.open(
				'/docs/Product/S2E-Module/W5500S2E-S1/w5500s2e_s1',
				'_self'
			);
		case 'W7500S2E-S1':
			return window.open(
				'/docs/Product/S2E-Module/W5500S2E-Z1/w5500s2e_z1',
				'_self'
			);
		case 'WIZ750SR':
			return window.open(
				'/docs/Product/S2E-Module/WIZ750SR/wiz750sr',
				'_self'
			);
		case 'WIZ550SR':
			return window.open(
				'/docs/Product/S2E-Module/WIZ550SR/wiz550sr',
				'_self'
			);
		case 'WIZ550S2E':
			return window.open(
				'/docs/Product/S2E-Module/WIZ550S2E/wiz550s2e',
				'_self'
			);
		case 'WIZ107SR':
			return window.open(
		...
		case 'WIZ610io':
			return window.open(
				'/docs/Product/ioModule/WIZ610io/wiz610io',
				'_self'
			);
		case 'WIZ610MJ':
			return window.open(
				'/docs/Product/ioModule/WIZ610MJ/wiz610mj',
				'_self'
			);
		case 'WIZ810Sio':
			return window.open(
				'/docs/Product/ioModule/WIZ810Sio/wiz810sio',
				'_self'
			);
		case 'WIZ810SMJ':
			return window.open(
				'/docs/Product/ioModule/WIZ810SMJ/wiz810smj',
				'_self'
			);
		case 'WIZ850io':
			return window.open(
				'/docs/Product/ioModule/WIZ850io/wiz850io',
				'_self'
			);
		case 'WIZ550io':
			return window.open(
				'/docs/Product/ioModule/WIZ550io/overview',
				'_self'
			);
		case 'WIZ820io':
			return window.open(
		...
		case 'WIZ550web':
			return window.open(
				'/docs/Product/App-Module/WIZ550web/wiz550web',
				'_self'
			);
		case 'WizFi360':
			return window.open(
				'/docs/Product/Wi-Fi-Module/WizFi360/wizfi360',
				'_self'
			);
		case 'WizFi250':
			return window.open(
				'/docs/Product/Wi-Fi-Module/WizFi250/wizfi250',
				'_self'
			);
		case 'WizFi310':
			return window.open(
				'/docs/Product/Wi-Fi-Module/WizFi310/wizfi310',
				'_self'
			);
		case 'WizFi630S':
			return window.open(
				'/docs/Product/Wi-Fi-Module/WizFi630S/wizfi630s',
				'_self'
			);
		case 'WizFi630A':
			return window.open(
				'/docs/Product/Wi-Fi-Module/WizFi630A/wizfi630a',
				'_self'
			);

		case 'WIZwiki-W7500':
			return window.open(
				'/docs/Product/Mbed-WIZwiki-Platform/WIZwiki-W7500/overview',
				'_self'
			);
		case 'WIZwiki-W7500P':
			return window.open(
				'/docs/Product/Mbed-WIZwiki-Platform/WIZwiki-W7500P/overview',
				'_self'
			);
		case 'WIZwiki-W7500ECO':
			return window.open(
				'/docs/Product/Mbed-WIZwiki-Platform/WIZwiki-W7500ECO/overview',
				'_self'
			);
		case 'WIZwiki-W7500 Mbed Starter Kit':
			return window.open(
				'/docs/Product/Mbed-WIZwiki-Platform/WIZwiki-W7500-Mbed-Starter-Kit/wizwiki_w7500_mbed_starter_kit',
				'_self'
			);
		case 'W5100S (MKR-)Ethernet Shield':
			return window.open(
				'/docs/Product/Open-Source-Hardware/w5100s_mkr_ethernet_shield',
				'_self'
			);
		case 'W6100 (MKR-)Ethernet Shield':
			return window.open(
				'/docs/Product/Open-Source-Hardware/w6100_mkr_ethernet_shield',
				'_self'
			);
		case 'WizArduino M0 ETH':
			return window.open(
				'/docs/Product/Open-Source-Hardware/wizarduino_m0_eth',
				'_self'
			);
		case 'WizArduino MEGA WIFI':
			return window.open(
				'/docs/Product/Open-Source-Hardware/wizarduino_mega_wifi',
				'_self'
			);
		case 'WizFi310 Shield':
			return window.open(
				'/docs/Product/Open-Source-Hardware/wizfi310_shield',
				'_self'
			);
		case 'W5500 Ethernet Shield':
			return window.open(
				'/docs/Product/Open-Source-Hardware/w5500_ethernet_shield',
				'_self'
			);
		case 'ioShield-A':
			return window.open(
				'/docs/Product/Open-Source-Hardware/ioshield_a',
				'_self'
			);
		case 'ioShield-K':
			return window.open(
				'/docs/Product/Open-Source-Hardware/ioshield_k',
				'_self'
			);
		case 'ioShield-L':
			return window.open(
				'/docs/Product/Open-Source-Hardware/ioshield_l',
				'_self'
			);
		case 'WIZ750SR-100':
			return window.open(
				'/docs/Product/S2E-Module/WIZ750SR-1xx-Series/WIZ750SR-100/wiz750sr_100',
				'_self'
			);
		case 'WIZ750SR-105':
			return window.open(
				'/docs/Product/S2E-Module/WIZ750SR-1xx-Series/WIZ750SR-105/wiz750sr_105',
				'_self'
			);
		case 'WIZ750SR--110':
			return window.open(
				'/docs/Product/S2E-Module/WIZ750SR-1xx-Series/WIZ750SR-110/wiz750sr_110',
				'_self'
			);
		case 'WIZ752SR-120':
			return window.open(
				'/docs/Product/S2E-Module/WIZ752SR-12x-Series/WIZ752SR-120/wiz752sr_120',
				'_self'
			);

		case 'WIZ752SR-125':
			return window.open(
				'/docs/Product/S2E-Module/WIZ752SR-12x-Series/WIZ752SR-120/wiz752sr_125',
				'_self'
			);
		default:
			return null;
